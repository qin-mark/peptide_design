...
class LaMBO(object):
    ...
    def optimize(self, candidate_pool, pool_targets, all_seqs, all_targets, log_prefix=''):
        ...
        for round_idx in range(1, self.num_rounds + 1):
            ...
            #TODO:update our scoring funtion
            new_candidates_temp=new_candidates
            new_seqs_temp=new_seqs
            new_targets = []
            all_metrics_candidate = []
            for seq, candidates in zip(new_seqs_temp, new_candidates_temp):
                ...
                try:
                    ...
                    with open('faild_seq.txt','a')as f:
                        f.write(seq+'\n')
            ...
            pool_targets = np.concatenate((pool_targets, new_targets))   #add target and seq to pool
